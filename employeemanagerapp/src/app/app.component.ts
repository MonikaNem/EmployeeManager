...
export class AppComponent implements OnInit {
  ...
  public onOpenModal(employee: Employee, mode: string): void {
    ...
    if (mode === 'edit') {
      this.editEmployee = employee; // !!!!!!!!! "editEmployee je nastaven na aktuálního employee"
      button.setAttribute('data-target', '#editEmployeeModal');
    }
    if (mode === 'delete') {
      this.deleteEmployee = employee; // "deleteEmployee je nastaven na aktuálního employee"
